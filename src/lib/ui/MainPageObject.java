...
public class MainPageObject {
    ...
    public String assertElementHasText(By by, String error_message, String expected_text) throws Exception {
    ...
    public boolean assertElementContainsText(By by, String error_message, String expected_text) throws Exception {
        WebElement element = waitForElementPresent(by, error_message, 5);
        String actual_text = element.getAttribute("text");
